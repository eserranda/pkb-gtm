...
@section('content')
    ...
    @include('pages.anggota-pkb.add')
    @include('pages.anggota-pkb.edit')
@endsection
...
@push('scripts')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            // fetch data klasis yang ada pada tabel anggota-pkb 

            // fetch('/anggota-pkb/getIdAndNameAllKlasis')
            ...
            $('#filterData').on('change', function() {
                ...
                datatable.ajax.url('{{ route('anggota-pkb.index') }}?filter=' + selectedFilter)
                    .load();
            });

            $('#reload').on('click', function() {
                $('#filterData').val('');
                datatable.ajax.url('{{ route('anggota-pkb.index') }}').load();
            });
