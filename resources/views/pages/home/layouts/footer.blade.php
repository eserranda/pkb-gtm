...
<footer class="site-footer section-padding">
    <div class="container">
        <div class="row">
            ...
            <p class="copyright-text mt-lg-5 mt-4">Copyright © 2024 PKB GTM. All rights reserved.
...
<script src="{{ asset('home_assets') }}/js/jquery.sticky.js"></script>
<script src="{{ asset('home_assets') }}/js/click-scroll.js"></script>
